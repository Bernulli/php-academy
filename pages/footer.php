...
<footer class="main-footer">
        <div class="container">
            <p class="footer-contacts">
                Блог<br>
                Адреса: м. Рівне, вул. Соборна<br>
                <a href="#">Як нас знайти?</a><br>
                Телефон: +38 (068) 668 23 55
            </p>
            <div class="footer-social">
                <b>Давайте дружити!</b>
                <ul>
                    <li><a class="social-button" href="#"><span class="visually-hidden"></span>
            ...
            <p class="footer-copyright">
                <b>Розроблено:</b> <a class="button" href="#">DRGroup</a>
            </p>
        </div>
    </footer>
</body>
